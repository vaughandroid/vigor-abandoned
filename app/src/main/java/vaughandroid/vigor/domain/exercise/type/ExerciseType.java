 ...
 * @author Chris
 */
@AutoValue public abstract class ExerciseType implements Serializable {
  ...
  public static Builder builder() {
    return new AutoValue_ExerciseType.Builder().id(ExerciseTypeId.UNASSIGNED);
  }

  @NonNull public abstract ExerciseTypeId id();
  ...
  public static class NameComparator implements Comparator<ExerciseType> {
    ...
    @Override public int compare(ExerciseType o1, ExerciseType o2) {
