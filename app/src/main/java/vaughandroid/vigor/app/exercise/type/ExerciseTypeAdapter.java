 ...
 * @author Chris
 */
public class ExerciseTypeAdapter
    extends RecyclerView.Adapter<ExerciseTypeAdapter.ExerciseTypeViewHolder> {
  ...
  private final Observable<ExerciseType> exerciseTypeObservable =
      Observable.create(exerciseTypeOnSubscribe);
  ...
  @Override public ExerciseTypeViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(parent.getContext())
        .inflate(R.layout.item_exercise_type, parent, false);
    return new ExerciseTypeViewHolder(view);
  }

  @Override public void onBindViewHolder(ExerciseTypeViewHolder holder, int position) {
  ...
  public class ExerciseTypeViewHolder extends RecyclerView.ViewHolder {
    ...
    @SuppressWarnings("NullableProblems") @NonNull ExerciseType exerciseType;
    ...
    @OnClick(R.id.item_exercise_type_TextView) void onClick() {
  ...
  private class ExerciseTypeOnSubscribe implements Observable.OnSubscribe<ExerciseType> {
    ...
    @Override public void call(Subscriber<? super ExerciseType> subscriber) {
